"""Encodeur et décodeur du VAE audio pour LTX-2."""
...
def build_mid_block(
    ...
    """Construit le bloc central avec deux blocs ResNet et une attention optionnelle."""
    mid = {}
...
def run_mid_block(mid: dict, features: mx.array) -> mx.array:
    """Fait passer les caractéristiques à travers le bloc central."""
