...
Wraps Gemma 3 (12B by default) as a frozen text encoder for video and audio
prompt embeddings. Compared to the original implementation, the prompt
enhancement / generation methods have been removed: prompt rewriting is
expected to be done upstream by the calling application.
"""
...
from ...utils.common import apply_quantization, rms_norm
